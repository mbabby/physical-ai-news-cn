...
const publicationFixtures: Record<string, string> = {
  ...
  "site/data/core-coverage.json": "old core snapshot\n",
  "site/data/core-coverage-history.json": "old public core history\n",
  "site/data/watchlist-changes.json": "old changes\n",
  "site/feeds/manifest.json": "old feed\n",
  "site/feeds/core-coverage.xml": "old core feed\n",
