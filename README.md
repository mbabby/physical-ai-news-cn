...
- [Track4Action：将世界中心3D追踪器蒸馏进视觉-语言-动作策略](https://arxiv.org/abs/2608.03727v1)<br>Track4Action将冻结的世界中心3D追踪器的转移信息蒸馏进VLA策略，仅训练时作对齐目标，部署无需追踪器；零样本LIBERO-Plus达82.3%，真机双臂任务提升25个百分点。

- [PhyAI：统一边缘与云端的实时物理 AI 推理引擎](https://arxiv.org/abs/2608.03682v1)<br>PhyAI 以单一运行时统一 VLA 模型与世界动作模型在端侧、边缘及云端的推理，较 pi0、pi0.5、GR00T N1.7 等官方实现提速 1.40 至 4.65 倍。
