...
> 数据刷新至 2026-08-07 · 最近确证产业事件 2026-08-01 · 关键进展按影响力排序，最新动态按更新时间排序。
...
> arXiv 暂未刷新，以下为最近一次成功抓取（2026-08-07）的完整研究卡。

- [自主缝合中通过缝线操控间接拾取手术针](https://arxiv.org/abs/2607.26337v1) <kbd>真实机器人</kbd> <kbd>CMU</kbd><br>该研究提出以缝线为辅助工具间接拾取手术针的自主框架，涵盖重建、抓取点选择与双臂沿线追踪，可在针被遮挡或难以接近时避免器械接触组织。在 da Vinci Research Kit 上的真实实验表明其在复杂缝线条件下仍具鲁棒性。<br>值得关注：来自 CMU；提供真实机器人证据。<br><sub>重点作者 / 实验室：Zih-Yun Chiu · CMU</sub>

- [DreamWAM：超越RGB未来预测的世界动作模型](https://arxiv.org/abs/2608.04996v1) <kbd>真实机器人</kbd> <kbd>基准</kbd> <kbd>开源</kbd><br>DreamWAM将未来预测重构为超越RGB的结构化世界建模，用外观、运动、几何和语义的互补视图表示未来状态，推理时仅保留RGB分支。它在LIBERO及扰动基准和真实机器人操作任务上均超过RGB-only基线，代码与模型已开源。<br>值得关注：提供真实机器人、基准、开源证据。

- [RedFlow：将失败重定向为流匹配VLA策略的动作级纠错](https://arxiv.org/abs/2607.27782v1) <kbd>真实机器人</kbd> <kbd>基准</kbd><br>RedFlow提出细粒度离线强化学习框架，通过上下文感知纠错匹配与自适应重定向目标，将失败经验转化为动作级纠正监督。在LIBERO基准与三项真实操作任务上，其真实成功率由56.7%升至74.7%，并以约少一个数量级的样本比肩PPO等在策略方法。<br>值得关注：提供真实机器人、基准证据。<br><sub>重点作者 / 实验室：Zehong Yan</sub>
