...
- [ω-0：实现人形机器人移动与操作并行的潜在预测世界动作模型](https://arxiv.org/abs/2608.06375v1) <kbd>真实机器人</kbd><br>提出 ω-0，一个全身潜在预测世界动作模型，直接由语言指令、视觉与本体状态生成可执行的全身动作隐变量。在 11 项真实家庭任务上，单一模型即优于模仿学习、VLA 与人形基线。<br>值得关注：提供真实机器人证据。<br><sub>重点作者 / 实验室：Zhenzhe Zhang</sub>
