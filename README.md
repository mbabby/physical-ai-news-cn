...
- [Track4Action：将世界中心3D跟踪器蒸馏进视觉语言动作策略](https://arxiv.org/abs/2608.03727v1)<br>Track4Action 将冻结的世界中心3D跟踪器特征蒸馏进视觉语言动作策略，部署时无需跟踪器，零样本 LIBERO-Plus 达82.3%，并提升 RoboTwin 2.0 与真实双臂任务成功率。

- [PhyAI：统一物理 AI 推理引擎，覆盖边缘到云端部署](https://arxiv.org/abs/2608.03682v1)<br>PhyAI 以单一运行时统一物理 AI 推理，支持 VLA 与 WAM 模型在板端、边缘及云端多 GPU 部署，对 pi0.5、GR00T N1.7 等官方实现实现 1.40 至 4.65 倍加速。
...
- [AtVLA：面向视觉-语言-动作模型的自适应视觉细化框架](https://arxiv.org/abs/2608.02197v1)<br>AtVLA 向视觉编码器注入可学习寄存器 token 以修复注意力伪影，并按不确定度门控对关键区域高分辨率重编码，LIBERO 成功率升至 98.4%，真实任务升至 69.0%。
