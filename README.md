...
- [DreamWAM：超越RGB未来预测的世界动作模型](https://arxiv.org/abs/2608.04996v1) <kbd>真实机器人</kbd> <kbd>基准</kbd> <kbd>开源</kbd><br>DreamWAM提出超越RGB的结构化未来状态建模，联合外观、运动、几何与语义表示来训练动作模型。该方法在LIBERO基准与真实机器人操作上均优于RGB基线，代码与模型已开源。<br>值得关注：提供真实机器人、基准、开源证据。
...
- [JoyAI-RA 0.5：通过双重动作对齐扩展机器人操作学习](https://arxiv.org/abs/2608.05674v1) <kbd>真实机器人</kbd> <kbd>基准</kbd><br>提出通用策略框架 JoyAI-RA 0.5，以隐式与显式双重动作对齐，将人类第一视角视频、仿真与真实机器人数据统一用于操作学习。在 AgiBot 真实基准上对已见与未见任务均表现强劲，得分随人类预训练数据增加持续提升且未见饱和。<br>值得关注：提供真实机器人、基准证据。
