...
| --- | ---: | ---: | ---: | ---: |
| 2026-08-22 | 12 | 49 | 98 | 13 / 27 |

**运行健康**：近 30 天日历覆盖 20/30（67%） · 已归档运行成功 20/20（100%） · A/B 级证据比例 100% · [查看 Actions](https://github.com/mbabby/physical-ai-news-cn/actions) · [信源健康分](resources/source-network.md) · [候选 Review](review/cases.md)
...
> 数据刷新至 2026-08-22 · 最近确证产业事件 2026-08-21 · 近 30 天事件按真实发生/公告日期筛选；核验时间不冒充事件时间。
