...
- [G0.5：以单一自回归流统一机器人推理与动作](https://arxiv.org/abs/2608.11739v1) · arXiv · Robotics · 2026-08-12<br>研究提出预训练自回归模型 G0.5，由单一解码器在统一目标下交错生成推理与动作词元，并配跨本体动作分词器与视觉记忆。它在 R1lite 与 R1pro 真机、BEHAVIOR 挑战赛及 LIBERO 等 7 项评测中超越现有最优模型。
