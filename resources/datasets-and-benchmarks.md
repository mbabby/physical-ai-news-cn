...
- [BridgeVLA++：带时空记忆的数据高效 3D 视觉语言动作框架](https://arxiv.org/abs/2608.05042v1) · arXiv · Robotics · 2026-08-05<br>该研究在 BridgeVLA 上加入统一时空记忆架构，以建模持久空间上下文与时间交互历史。该框架在两个记忆依赖基准上达到最优，并在真实机器人平台与双臂操作中得到验证。
