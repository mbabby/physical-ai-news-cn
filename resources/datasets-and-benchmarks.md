...
- [RedFlow：将失败重定向为流匹配VLA策略的动作级纠错](https://arxiv.org/abs/2607.27782v1) · arXiv · Robotics · 2026-07-30<br>RedFlow提出细粒度离线强化学习框架，通过上下文感知纠错匹配与自适应重定向目标，将失败经验转化为动作级纠正监督。在LIBERO基准与三项真实操作任务上，其真实成功率由56.7%升至74.7%，并以约少一个数量级的样本比肩PPO等在策略方法。
