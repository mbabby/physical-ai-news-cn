...
- [PhyAI：统一边缘与云端部署的实时物理 AI 推理引擎](https://arxiv.org/abs/2608.03682v1) · arXiv · Robotics · 2026-08-04<br>PhyAI 以单一运行时统一视觉语言动作模型与世界动作模型的推理，覆盖板端、边缘与云端部署，较官方实现提速1.4至4.65倍。
