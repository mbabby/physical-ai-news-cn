...
**谁在做**：3 家已建档公司；2 家已有可追溯资本或产品 / 部署信号。  
...
**持续跟踪（尚缺可归属的资本或验证事件，不代表未融资或未进展）**：[自变量机器人](https://x2robot.com/)
