...
- [DreamWAM：超越RGB未来预测的世界动作模型](https://arxiv.org/abs/2608.04996v1) · arXiv · Robotics · 2026-08-05<br>DreamWAM将未来预测重构为超越RGB的结构化世界建模，用外观、运动、几何和语义的互补视图表示未来状态，推理时仅保留RGB分支。它在LIBERO及扰动基准和真实机器人操作任务上均超过RGB-only基线，代码与模型已开源。
