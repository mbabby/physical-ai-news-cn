...
- [DreamWAM：超越RGB未来预测的世界动作模型](https://arxiv.org/abs/2608.04996v1) · arXiv · Robotics · 2026-08-05<br>DreamWAM提出超越RGB的结构化未来状态建模，联合外观、运动、几何与语义表示来训练动作模型。该方法在LIBERO基准与真实机器人操作上均优于RGB基线，代码与模型已开源。
