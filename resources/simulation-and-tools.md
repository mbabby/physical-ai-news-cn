...
- [借助缝线操作实现自主缝合中的柔性缝针拾取](https://arxiv.org/abs/2607.26337v1) · arXiv · Robotics · 2026-07-28<br>研究提出一种自主框架，以缝线作为辅助工具间接拾取缝针，避免器械与组织的不必要接触，即使缝针被遮挡或无法直接接近也能完成拾取。在 da Vinci Research Kit 上的多种真实环境实验表明，该框架在复杂缝线形态或缝针无法接近的情况下仍表现稳健。
