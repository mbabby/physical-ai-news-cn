...
- [FOCI Policy：聚焦物体间交互的关系型操作策略](https://arxiv.org/abs/2609.08743v1) · arXiv · Robotics · 2026-09-08<br>该工作提出FOCI Policy，从示范中自动提取紧凑交互片段，并以任务相关物体间的相对SE(3)运动表示技能。在RLBench、COLOSSEUM及真实任务上的实验表明，其以更少的训练数据优于先前的物体中心与动作中心策略。

- [CLAP：跨本体动作条件视频世界模型实现零样本物理模拟](https://arxiv.org/abs/2608.27406v1) · arXiv · Robotics · 2026-08-27<br>CLAP提出跨本体动作条件视频生成框架，统一末端执行器位姿、语言与潜在动作等异构动作空间。其在DROID等基准上接近或超越单本体最优模型，并开源全部代码与模型。
