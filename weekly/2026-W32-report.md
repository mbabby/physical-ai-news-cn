...
> 截止 2026-08-05。只纳入主体明确、中文事实简介完整、且具 A/B 级非线索证据的公开条目。
...
- [自主缝合中通过缝线牵引实现灵活的缝针间接拾取](https://arxiv.org/abs/2607.26337v1)：研究提出以缝线为辅助工具间接拾取缝针的自主框架，涵盖缝线重建、抓取点选择与双臂循线抓针。在 da Vinci Research Kit 真实环境实验中，即使缝线复杂或缝针不可接近也能稳健完成拾取。
